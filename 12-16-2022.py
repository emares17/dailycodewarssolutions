...
# the DNA (string, except for Haskell); you need to return the other complementary side. DNA strand is never empty or there 
...
def DNA_strand(dna):
    ...
    return ''.join([strands[i] for i in dna])