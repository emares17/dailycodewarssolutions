...
# For the languages where the string is not immutable (such as ruby), don't modify the given string, 
# otherwise this will break the test cases.

# ----------------------------Solution----------------------------

def covfefe(s):
    return s.replace("coverage", "covfefe") + (" covfefe" if "coverage" not in s else "")
