...
# Note
# The values at even positions need to be squared. For a language with zero-based indices, this will occur at 
# oddly-indexed locations. For instance, in Python, the values at indices 1, 3, 5, etc. should be squared because these are the second, fourth, and sixth positions in the list.
...
# Elements at indices 1, 3 are 12 and 14 and they are at even position. So we need to add 11, 13, 15 
# as they are and square of 12 and 14

# -----------------------------------Solution-----------------------------------
def alternate_sq_sum(arr):
    return sum(c ** 2 if i % 2 == 1 else c for i, c in enumerate(arr))
